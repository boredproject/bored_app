...
const DropdownMenuLogin: React.FC<DropdownMenuLoginProps> = ({
  isOpen,
  toggleDropdown,
}) => {
  ...
  const handleLoginSubmit = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Stocke le token JWT dans le local storage et les informations de l'utilisateur
        toggleDropdown(); // Ferme le menu de connexion
      } else {
