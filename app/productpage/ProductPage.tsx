                        ...
                        <td className="flex justify-between border-4 border-[#5E2BFF] rounded p-2 hover:bg-[#5E2BFF] transition duration-500 font-bold text-3xl uppercase">
                          ...
                          <div className="flex justify-between border-4 border-[#5E2BFF] rounded p-2 w-[6%] text-center uppercase">
                            ...
                            <figure>
                              ...
                              <path d="M43.1208 154.015L40.9906 163.224L49.084 158.342L90.5002 133.358L131.916 158.342L140.01 163.224L137.88 154.015L126.98 106.894L163.537 75.1994L170.677 69.0093L161.263 68.1921L112.963 63.9994L94.1846 19.5678L90.5002 10.8501L86.8157 19.5678L68.0371 63.9994L19.7376 68.1921L10.3233 69.0093L17.4632 75.1994L54.0208 106.894L43.1208 154.015Z" fill="#181818" stroke="#5E2BFF" stroke-width="8"/>
                            </svg></figure>
