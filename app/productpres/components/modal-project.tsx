...
const Modal = () => {
    return (
        <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center'>
            ...
            <div className="flex bg-[#181818] p-6 h-3/4 lg:w-2/3 w-3/4 border-solid border-[#5E2BFF] border-4 rounded text-white flex-col lg:flex-row lg:flex-wrap overflow-auto lg:justify-around">
                {/* image du lieu */}
