<template>
    <div class="fixed top-0 right-0 p-4 flex flex-row gap-6 text-white">
        <svg class="cursor-pointer" width="28" height="28" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="cursor-pointer" width="29" height="23" viewBox="0 0 29 23" fill="none" xmlns="http://www.w3.org/2000/svg">
